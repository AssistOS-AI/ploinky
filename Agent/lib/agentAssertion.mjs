 ...
 * (source agent → router, DS015 / Phase 3).
 *
...
function signAgentAssertionWithRch({ secret, self, method, path, targetAgent, tool, rch }) {
    ...
    // The assertion MUST bind the addressed target (DS015). A target-less
 ...
 * reuse the stable DS015 PLOINKY_AGENT_SECRET: disable/re-enable and instance
