...
export function computeRchMachineCall({
    callerAgentId,
    callerEnableGeneration,
    targetAgentId,
    port,
    method,
    path,
    ...
    return computeRch({
        callerAgentId: String(callerAgentId ?? ''),
        callerEnableGeneration: String(callerEnableGeneration ?? ''),
        targetAgentId: String(targetAgentId ?? ''),
        port: String(port ?? ''),
        method: String(method ?? '').toUpperCase(),
        path: String(path ?? ''),
