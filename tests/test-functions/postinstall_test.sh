check_postinstall_marker() {
  ...
  # Postinstall writes to WORKSPACE_PATH which is $TEST_RUN_DIR/.data/<agent>/
  local marker_path="$TEST_RUN_DIR/.data/$TEST_AGENT_DEP_GLOBAL_NAME/postinstall_marker.txt"
