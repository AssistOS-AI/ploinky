// Frozen copy of the pre-transaction skill exporter (Explorer
// explorer/utils/server/managed-skill-exports.mjs at f3e50c07, identical to
// the earlier Ploinky exporter apart from its link factory). Mixed-version
// tests run it against the transaction protocol. Do not modernize it.
