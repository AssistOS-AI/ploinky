...
const PREDEFINED_REPOS = {
    ...
    DocumentationSkills: { url: 'https://github.com/AssistOS-AI/DocumentationSkills.git', description: 'Documentation skill catalog', kind: 'skills' },
    PloinkySkills: { url: 'https://github.com/AssistOS-AI/PloinkySkills.git', description: 'Ploinky skill catalog', kind: 'skills' }
};
